        ...
        <div class="container-fluid">
            <nav class="navbar navbar-expand-lg stroke">
                <h1>
                    ...
                    Phoenix <i class="fa fa-cutlery ml-2" aria-hidden="true"></i></a>
                </h1>
        ...
        <img src="image-path" alt="Your logo" title="Your logo" style="height:35px;" />
                ...
                <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                    <ul class="navbar-nav ml-lg-auto">
                        ...
                        <!-- <li class="nav-item {{ request()->is('cus_login') ? 'active' : '' }}">
                            <a class="nav-link" href="{{url('/cus_login')}}">login</a>
                        </li> -->

                        <li class="nav-item {{ request()->is('booking') ? 'active' : '' }}">
                            <a class="nav-link" href="{{url('/booking')}}">Table Booking</a>
                        </li>
