...
<body>
    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="nav-link scrollto" href="{{url('/cus_login')}}">login</a></li>
  ...
  <main id="main">
    ...
    <section id="book-a-table" class="book-a-table" style="background-image:url('public/assets/img/slide/slide-1.jpg')">
      <div class="container">
